...
const wasteImages = [
  { src: "public/plastic-bottles-recycle-images.webp", stage: "Collection" },
  { src: "public/Waste-Energy-image.jpg", stage: "Sorting" },
  { src: "public/Waste-Energy-landfill.webp", stage: "Processing" },
  { src: "public/Waste-Energy-Machines.webp", stage: "Power Generation" },
];

function Dashboard({ images = wasteImages, interval = 4000 }) {
    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col justify-between px-6 py-10 md:px-12 md:py-14">
        ...
        <div className="max-w-3xl">
          ...
          <h1 className="font-mono text-4xl font-bold leading-[1.08] tracking-tight text-[#1E5B3E] sm:text-5xl lg:text-6xl">
